const WordsAndDefinitions = [
    ...
    ["Rolle'sTheorem", "A theorem stating that if a function is continuous on a closed interval and differentiable on the open interval, and has equal values at the endpoints, then there exists at least one point in the open interval where the derivative is zero."],
    ["L'Hopital'sRule", "A rule used to evaluate the limit of a quotient of two functions when the limit of the numerator and denominator is either zero or infinity, by taking the limit of the quotient of their derivatives."],
    ["Tangent Line", "A straight line that touches a curve at a single point and has the same slope as the curve at that point."],
    ["NormalLine", "A straight line that is perpendicular to the tangent line at the point of tangency on a curve."],
    ["SecantLine", "A straight line that intersects a curve at two or more points."],
    ...
    ["RiemannSum", "A method for approximating the definite integral of a function by summing the areas of rectangles or trapezoids over an interval."],
