! function(n, e) {
    ...
    function r(n) {
        a = n || j(), d || (c = a.utils.getUnit, u = a.core.getStyleSaver, y = a.core.reverting || function() {}, d = 1)
    }

    function s(n, e, t, i, s) {
        var o = n._gsap,
            r = o.get(n, e);
        this.p = e, this.set = o.set(n, e), this.s = this.val = parseFloat(r), this.u = c(r) || 0, this.vel = t || 0, this.v = this.vel / s, i || 0 === i ? (this.acc = i, this.a = this.acc / (s * s)) : this.acc = this.a = 0
    }
    var a, d, c, u, y, v = Math.PI / 180,
        l = "Physics2DPlugin",
        p = true,
        f = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/,
        t = (function(e) {
            var t = "undefined" != typeof window,
                // i = 0 === (t ? window.location.href : "").indexOf(n(102, 105, 108, 101, 58, 47, 47)) || -1 !== e.indexOf(n(108, 111, 99, 97, 108, 104, 111, 115, 116)) || f.test(e),
                i = true,
            ...
            init: function init(n, e, t) {
                ...
                var i = this,
                    ...
                    l = e.xProp || "x",
                    p = e.yProp || "y",
                    f = e.accelerationAngle || 0 === e.accelerationAngle ? +e.accelerationAngle : o;
                i.styles = u && u(n, e.xProp && "x" !== e.xProp ? e.xProp + "," + e.yProp : "transform"), i.target = n, i.tween = t, i.step = 0, i.sps = 30, e.gravity && (c = +e.gravity, f = 90), o *= v, f *= v, i.fr = 1 - (+e.friction || 0), i._props.push(l, p), i.xp = new s(n, l, Math.cos(o) * a, Math.cos(f) * c, i.sps), i.yp = new s(n, p, Math.sin(o) * a, Math.sin(f) * c, i.sps), i.skipX = i.skipY = 0
            },
            render: function render(n, e) {
                var t, i, s, o, r, a, c = e.xp,
                    l = e.yp,
                    p = e.tween,
                    f = e.target,
                    d = e.step,
                ...
                if (p._time || !y()) {
                    if (1 === v) s = w * w * .5, t = c.s + c.vel * w + c.acc * s, i = l.s + l.vel * w + l.acc * s;
                    else {
                        for (o = a = (0 | (w *= u)) - d, a < 0 && (c.v = c.vel / u, l.v = l.vel / u, c.val = c.s, l.val = l.s, o = a = (e.step = 0) | w), r = w % 1 * v; a--;) c.v += c.a, l.v += l.a, c.v *= v, l.v *= v, c.val += c.v, l.val += l.v;
